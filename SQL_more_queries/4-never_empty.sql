...
-- Execute the 4-never_empty.sql_no_comment script to create the table
mysql -hlocalhost -uroot -p$MYSQL_ROOT_PASSWORD $DATABASE_NAME < 4-never_empty.sql_no_comment
